...
#define NUM_COUNTERS_SKYLAKE 39
#define NUM_COUNTERS_CORE_SKYLAKE 17
#define NUM_COUNTERS_UNCORE_SKYLAKE 22
...
static RegisterMap skylake_counter_map[NUM_COUNTERS_SKYLAKE] = {
    ...
    /* System Agent Performance Status */
    {"MBOX0SAP0", PMC34, MBOX0SAP, 0x0, 0x5, 0, PCI_IMC_DEVICE_0_CH_0},
    /* PERF */
    {"MPERF", PMC35, PERF, 0, MSR_MPERF, 0, 0, EVENT_OPTION_NONE_MASK},
    {"APERF", PMC36, PERF, 0, MSR_APERF, 0, 0, EVENT_OPTION_NONE_MASK},
    {"PPERF", PMC37, PERF, 0, MSR_PPERF, 0, 0, EVENT_OPTION_NONE_MASK},
    /* Core Current Performance Status */
    {"CCPS0", PMC38, PERFSTAT, 0, MSR_PERF_STATUS, 0, 0, EVENT_OPTION_NONE_MASK},
};
